...
squid.changeRobot("https://66.media.tumblr.com/2f041a8346b40f6ef3361b3304a61582/tumblr_pj866gfzxE1v70mvs_250.jpg");
squid.miniaturize();
...
if(i%2==0) {
	squid.setPenColor(0,25,255);
}
			
			// #13. set the pen color to red for all odd numbers of i
else {
	squid.setPenColor(255,0,25);
}
